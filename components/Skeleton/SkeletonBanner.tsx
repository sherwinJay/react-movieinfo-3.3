  ...
  return (
    <div className='bg-slate-800'>
      <div role="status" className="w-[100%] m-auto px-[1em] py-[2em] md:p-[3em] md:grid md:grid-cols-bannerGrid_2Col md:gap-5 xl:w-[1200px] animate-pulse">
        <div className="hidden md:flex items-center justify-center w-full bg-gray-400 rounded sm:w-96 dark:bg-gray-600">
          <svg className="w-10 h-10 lg:w-[340px]] lg:h-[350px] text-gray-200 dark:text-gray-500" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">

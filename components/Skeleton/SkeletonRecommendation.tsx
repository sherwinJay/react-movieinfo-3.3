...
const SkeletonRecommendation = () => {
  return (
    <div className='bg-slate-800'>
      <div role="status" className="w-[100%] m-auto pt-4 px-4 md:px-5 py-[1.7em] flex flex-col animate-pulse lg:h-[315px]">
        <div className="h-5 bg-gray-400 rounded-full dark:bg-gray-600 w-full max-w-[200px] mb-7"></div>

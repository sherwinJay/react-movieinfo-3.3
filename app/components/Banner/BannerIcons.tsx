    ...
    if(videos?.results?.length > 0 && videos?.results[0]?.hasOwnProperty("key")){
      return (
        ...
        >
          ...
          <p className='text-[14px] md:text-[16px] leading-[19px] md:leading-[24px]'>Play Trailer</p>
        </a>
      )
    }
    return "";
  ...
  return (
    <div className='flex gap-[15px] md:gap-6 items-center'>
      ...
      <div className="flex gap-[2px] md:gap-1 items-center">
        ...
        <p className='text-[14px] md:text-[16px] leading-[19px] md:leading-[24px]'>{ computeRuntime() }</p>
      </div>
      <div className="">
       { getTrailer() }
      </div>
